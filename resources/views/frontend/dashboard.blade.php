            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                <div class="job_grid border rounded ">
                    ...
                    <div class="job_grid_footer pb-4 px-3 d-flex align-items-center justify-content-between">
                        <div class="df-1 text-muted"><i class="lni lni-wallet mr-1"></i>${{number_format($job->min_salary,2)}} - ${{number_format($job->max_salary,2)}}</div>
...
<section class="space min gray">
    <div class="container">
        ...
        <div class="row justify-content-center">
          @if(count($blogs) > 0)  <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
